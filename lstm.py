...
if __name__ == "__main__":
    ...
    INPUT_SIGNAL_TYPES = [ 'car_acc_x_',  'car_acc_y_', 'car_acc_z_', 'car_gyro_x_',  'car_gyro_y_',  'cat_gyro_z_'
    ]

    # Output classes to learn how to classify
    LABELS = [ 'POPPING',  'ROLLING',  'OTHER_PLAY',  'NON_PLAY']
    ]

    DATA_PATH = "data/"
    DATASET_PATH = DATA_PATH + "dataset_uci/"
    ...
    X_train_signals_paths = [
        ...
        DATASET_PATH + signal + TRAIN for signal in INPUT_SIGNAL_TYPES
    ]
